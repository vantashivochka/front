...
const Service: React.FC = () => {
  return (
    <section id="service" className="py-5 sm:py-10">
      ...
      <MaxWidthWrapper className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mt-6">
        ...
        <div className="flex flex-col w-full">
          <div className="relative">
            ...
            <p className="text-sm text-muted-foreground mt-5 text-center">
              Комплексна послуга, в яку входять збирання, транспортування та
              переробка відходів. Вивозимо будь-яке побутове або будівельне
              сміття
            </p>
        </div>
      </MaxWidthWrapper>
